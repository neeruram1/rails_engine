  ...
  describe 'Methods' do
    ...
    it "find_all_merchants()" do
      ...
      it "total_revenue" do
        ...
        invoice_item = InvoiceItem.create!(quantity: 30, unit_price: 10.75, item: item, invoice: invoice)
        invoice_item2 = InvoiceItem.create!(quantity: 14, unit_price: 4.75, item: item2, invoice: invoice2)
      ...
      it "revenue_by_date_range()" do
        ...
        expect(Merchant.revenue_by_date_range("2020-09-03", "2020-09-04")).to eq(6817.2)
      end
    end
  end
